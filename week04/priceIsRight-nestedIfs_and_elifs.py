...
PRICE_OF_SOFA = random.randint(1500, 2500)

# This game prompts two players about what they think is the price of a sofa
# The player that comes closest to the actual cost without going over wins
